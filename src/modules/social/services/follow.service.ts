...
import { PublicUserResource, PUBLIC_USER_SELECT, toPublicUserResource } from '../mappers/social.mapper';
...
export class FollowService {
  ...
  async follow(followerId: string, followingId: string): Promise<{ ok: true }> {
    if (followerId === followingId) {
      throw new BadRequestException(SocialResponseMessage.fail.CANNOT_FOLLOW_SELF);
    }
